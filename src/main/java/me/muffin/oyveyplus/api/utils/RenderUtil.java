...
public class RenderUtil implements Wrapper {
    ...
    public static void glBillboard(float x, float y, float z) {
        ...
        GlStateManager.translate((double) x - mc.getRenderManager().renderViewEntity.posY, (double) y - mc.getRenderManager().renderViewEntity.posY, (double) z - mc.getRenderManager().renderViewEntity.posZ);
