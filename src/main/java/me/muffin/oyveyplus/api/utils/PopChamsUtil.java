...
import me.muffin.oyveyplus.impl.modules.render.PopChams;
...
public class PopChamsUtil {
    ...
    public void onRenderWorld(final RenderWorldLastEvent event) {
        ...
        Color lineColorS = new Color(PopChams.instance.rL.getValue().intValue(), PopChams.instance.gL.getValue().intValue(), PopChams.instance.bL.getValue().intValue(), PopChams.instance.aL.getValue().intValue());
        Color fillColorS = new Color(PopChams.instance.rF.getValue().intValue(), PopChams.instance.gF.getValue().intValue(), PopChams.instance.bF.getValue().intValue(), PopChams.instance. aF.getValue().intValue());
        ...
        if (this.player != null && this.playerModel != null) {
            ...
            GL11.glEnable(2881);
            GL11.glEnable(2848);
            if (alphaFill > 1) alphaFill -= PopChams.instance.fadetime.getValue();
            Color fillFinal = new Color(fillColor.getRed(), fillColor.getGreen(), fillColor.getBlue(), (int)alphaFill);

            if (alphaLine > 1) alphaLine -= PopChams.instance.fadetime.getValue();
