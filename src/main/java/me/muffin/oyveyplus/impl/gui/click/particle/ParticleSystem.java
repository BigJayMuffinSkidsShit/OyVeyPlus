...
public class ParticleSystem
{
    ...
    public void render() {
        ...
        for (final Particle particle : this.particleList) {
            GL11.glColor4f(ClickGui.color.getRed() / 255.0f, ClickGui.color.getGreen() / 255.0f, ClickGui.color.getBlue() / 255.0f, particle.getAlpha() / 255.0f);
            ...
            this.drawLine(particle.getX(), particle.getY(), nearestParticle.getX(), nearestParticle.getY(), ClickGui.color.getRed() / 255.0f, ClickGui.color.getGreen() / 255.0f, ClickGui.color.getBlue() / 255.0f, alpha);
        }
        GL11.glPushMatrix();
