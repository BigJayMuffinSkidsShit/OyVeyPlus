...
public class CrystalAura extends Module {
    ...
    public Setting<String> mode = this.register("Mode","ClientTick","ClientTick","MotionTick");
    public Setting<String> placeMode = this.register("PlaceMode","MostDmg","Closest","Priority","MostDmg");
    public Setting<String> breakMode = this.register("BreakMode","Always","Always","Smart");
    public Setting<String> logicMode = this.register("LogicMode","PlaceBreak","PlaceBreak","BreakPlace");
    ...
    public Setting<String> placeHand = this.register("PlaceHand","Offhand","MainHand","OffHand");
    ...
    public Setting<String> breakHand =  this.register("BreakHand","MainHand","Offhand","MainHand");
    ...
    public Setting<String> weaknessSwitch = this.register("WeaknessSwitch","None","Silent","Normal","None");
    ...
    public Setting<Double> facePlaceHealth = this.register("FcePlceHlth",8,0,36,0);

    public Setting<Boolean> armourBreak = this.register("ArmourBreak",true);
    public Setting<Double> armourBreakHealth = this.register("ArmourBrkHlth",20,0,100,0);
    ...
    public void onUpdate() {
        ...
        if(mode.getValue().equalsIgnoreCase("ClientTick")) {
            doAutoCrystal();
        }
    }

    @EventHandler
    private final Listener<MoveEvent> listener = new Listener<>(event -> {
        if(mode.getValue().equalsIgnoreCase("MotionTick")) {
            doAutoCrystal();
        }
    });
