...
public class HoleESP extends Module {
    ...
    public static ArrayList<BlockPos> tmpholes = new ArrayList<BlockPos>();
...
public void Update() {
	// TODO Auto-generated method stubS
        Renderer.filledBoxes.clear();
	for(BlockPos b : BlockUtil.getAll((int) Math.round(range.getValue())))
	{	
