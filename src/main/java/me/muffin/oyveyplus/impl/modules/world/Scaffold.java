...
import me.muffin.oyveyplus.api.event.events.UpdateWalkingPlayerEvent;
...
public class Scaffold
    ...
    public Setting<Boolean> rotation = this.register("Rotate", false);
    ...
    public void Update() {
        ...
        if(mc.world.getBlockState(floored_pos).getBlock()== Blocks.AIR)
        {
            if(BlockUtil.canPlaceBlock(floored_pos))
                BlockUtil.placeBlock(floored_pos, EnumHand.MAIN_HAND, (boolean)rotation.getValue(), (boolean)rotation.getValue(), true);
